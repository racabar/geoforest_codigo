...
En el directorio _modulos_ están los módulos desarrollados para cargar y servir de apoyo en los scripts principales.

Los scripts principales están estructurados en orden para seguir el flujo de trabajo del TFM.

![Flujo de trabajo](img/flujo_trabajo.png)
